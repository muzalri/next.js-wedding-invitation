  ...
  return (
    <div className="max-w-xl mx-auto text-center relative" style={{ padding: "0 15px" }}>
      <div className="relative z-10" style={{ marginBottom: "20px" }}>
        <h2 className="font-dancing text-xl text-gold/80 mb-2" style={{ color: "#d4af37", marginBottom: "8px" }}>Reservasi</h2>
        <h3 className="font-greatvibes text-4xl md:text-5xl text-gold mb-4" style={{ color: "#d4af37", marginBottom: "16px", fontSize: "2.5rem" }}>Konfirmasi Kehadiran</h3>
